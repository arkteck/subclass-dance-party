$(document).ready(function() {
  ...
  $('.clearTheFloor').on('click', function(event) {
    ...
    setTimeout(function() {
      $('.lights').addClass('lightsOut');

      $('.lightsOut:hidden').fadeIn('slow');
    }, 6000);
    window.dancers = [];
  ...
  // let popup = function() {
  //   let stats = window.open('', 'wildebeest', 'width=300, height=300, scrollbars=1, resizable=1');
  //   setInterval(function() {
  //     let text = window.dancers.length;
  //     let html = '<html><head></head><body>' + text + '</body></html>';
  //     stats.document.open();
  //     stats.document.write(html);
